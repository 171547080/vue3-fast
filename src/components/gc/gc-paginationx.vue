<template>
    <div class="pagination">
        ...
        <div class="warp">
            <a-pagination @change="handelChange" :current="props.pageNo" :pageSize="props.pageSize" :total="getTotal"
                show-less-items showQuickJumper>
                <template #itemRender="{ 
...
import { TablexCfgType } from "./type/tablexUtils"
