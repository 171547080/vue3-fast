<template>
    <gc-modalx v-model:show="cfg.show" v-model:submitting="cfg.submitting" title="是否删除车牌识别" @on-ok="handelSubmit"
        :confirm="true">
        确认删除【 {{ formState.name }} 】
    </gc-modalx>
</template>

<script setup lang="ts" name="PopupLicensePlateDelete">
